...
do 
    ...
    # CUDA_VISIBLE_DEVICES=0 CUDA_LAUNCH_BLOCKING=1 python zoomgs_train.py \
    ...
    # # test zoomGS results
    # CUDA_VISIBLE_DEVICES=6 python zoomgs_test.py -m $outputdir -s $scene --iteration 30000 --target "cx"
    # # generate camera transition sequences
    CUDA_VISIBLE_DEVICES=0 python zoomgs_render.py -m $outputdir -s $scene --iteration 30000 --target "cx"
