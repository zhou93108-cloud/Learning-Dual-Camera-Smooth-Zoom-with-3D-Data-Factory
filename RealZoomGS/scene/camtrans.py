...
class MLPLip(nn.Module):
    def __init__(self, input_size, output_size, target=""):
        ...
        # self.x_head = nn.Sequential(nn.Linear(W*2, W*2),
        #                             nn.Linear(2*W, W),
        #                             nn.Linear(W, 3))
        
        # self.c_head = nn.Sequential(nn.Linear(W*2, W*2),
        #                             nn.Linear(2*W, W),
        #                             nn.Linear(W, 48))
    ...
    def forward(self, x, rotations, scales, means, opacity, c=1.0, target="cx"): 
        x = x.view(x.size(0), -1)
        ...
        return deta_x, deta_c, deta_r,  deta_s, deta_o
