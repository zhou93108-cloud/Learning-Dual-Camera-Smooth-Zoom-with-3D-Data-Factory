    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        if idx in ids:
            if view.T[2] > 0.6 or view.T[2] < -0.6:
                ...
                makedirs(os.path.join(render_path, str(idx)+'_x'), exist_ok=True)
                ...
                for ii in range(0, len(linear_views)):
                    ...
                    torchvision.utils.save_image(rendering, os.path.join(render_path, str(idx)+'_x06',  '%04d.png'%(ii+1)))
